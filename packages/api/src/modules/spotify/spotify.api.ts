 ...
 *
 */
export function getArtistsByIdRelatedArtists(
  id: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 *
 */
export function getMeAudiobooksContains(
  ids: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 *
 */
export function getMeEpisodesContains(
  ids: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 *
 */
export function deletePlaylistsByPlaylistIdFollowers(
  playlistId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 *
 */
export function getPlaylistsByPlaylistIdImages(
  playlistId: string,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
 ...
 *
 */
export function putPlaylistsByPlaylistIdImages(
  playlistId: string,
  body: string,
  opts?: Oazapfts.RequestOpts,
) {
 ...
 *
 */
export function getMeFollowingContains(
  $type: "artist" | "user",
  ids: string,
  opts?: Oazapfts.RequestOpts,
) {
 ...
 *
 */
export function getRecommendationsAvailableGenreSeeds(
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<
